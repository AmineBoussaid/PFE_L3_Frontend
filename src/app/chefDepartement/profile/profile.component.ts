...
import { Intervention, User, UserHist } from '../../models';
...
export class ProfileComponent implements OnInit{
  ...
  CountReclamation(): void {
    if (this.currentUser) {
      this.departementService.getByChefDepartement(this.currentUser.id).subscribe(
        departement => {
      ...
      this.interventionService.getInterventionsByCreateurId(this.currentUser.id).subscribe(
        intervention => {
